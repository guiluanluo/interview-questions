...
/*
 * TODO: will revisit it later, Feb 04, 2018, LL
 * Solution B: we know the following:
 * 1) if we flip a 0 to a 1, we must flip a 1 to a 0
 * 2) when we do that, the number will be bigger if and only if the 0-to-1 bit was to the left of the 1-to-0 bit
 * 3) we want to make the number bigger, but not unnecessarily bigger. therefore, we need to filip the right-most 0 which
 *    has ones on the right of it
 *
 * LUCY Idea:
 * Find Nex Bigger:
 * step 1: flip right most non-tailing 0: 11 0110 1111 1100     (bit 7 is 1, bit 8 is 0)
 * step 2: flip bit 8 to 1: 11 0111 1111 1100
 * step 3: bit 1-7 has 5 one bit, need to subtract one -> 4 one bits, move this 4 one bits to right most
 *
 * Find Pre Smaller:
 * step 1: flip right most tailing 1 : 11 0110 1111 1100     (bit 1 is 0, bit 2 is 1)
 * step 2: flip bit 2 to 0: 11 0110 1111 1000
 * step 3: flip bit 1 to 1: 11 0110 1111 1010
 */

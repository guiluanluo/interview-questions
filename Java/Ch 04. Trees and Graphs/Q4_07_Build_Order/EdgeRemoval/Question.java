...
public class Question {
  ...
  /**
   * Build the graph, adding the edge (a, b) if b is dependent on a. Assumes a pair is listed in “build order”. The pair
   * (a, b) in dependencies indicates that b depends on a and a must be built before b.
   */

...
/**
 * Optimized of Solution D: we should only need to search the entire tree once to find P and Q. we should then be able
 * to "bubble up" the findings to earlier nodes int the stack.
 *
 * TODO: skip for now, Jan 20, 2018 - LL
 */

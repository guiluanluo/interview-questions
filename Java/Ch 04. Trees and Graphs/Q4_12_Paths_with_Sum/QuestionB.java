...
/**
 *
 * TODO: review it later, jan20, 2018, LL
 * Solution B: optimized
 *
 * we repeat some work at solution A. for a path such as 10->5->3, we start with node 10, then we go to node 5. idealy,
 * we would like to resue this work.
 */

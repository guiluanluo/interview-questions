...
public class Square {
  ...
  public double right;
  public double size; //the length of side
  ...
  /**
   * Return the point where the line segment connecting mid1 and mid2 intercepts the edge of square 1. That is, draw a
   * line from mid2 to mid1, and continue it out until the edge of the square.
   */

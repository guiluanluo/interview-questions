...
/*
 * TODO: will review it later , Feb 10, 2018
 * Optimal way that takes advantage of both parts of the sorting:
 *
 * observations:
...
public class QuestionB {
  ...
  public static Coordinate partitionAndSearch(int[][] matrix, Coordinate origin, Coordinate dest, Coordinate pivot,
      int x) {

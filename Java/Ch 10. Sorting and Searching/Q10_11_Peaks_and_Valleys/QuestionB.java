...
/**
 * Optimal solution: to optimize pass the prior solution, we need to cut out the sorting step. the algorithm must
 * operate on an unsorted array.
 *
 * Let's revisit an example: {9,1,0,4,8,7}. for each three integers, the middle one should be the largest number; then
 * increase index by 2.
 */

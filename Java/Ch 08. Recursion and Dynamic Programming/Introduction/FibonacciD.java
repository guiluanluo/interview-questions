...
/**
 * if you really think about how Solution C works, you only use memo[i] for memo[i+1] and memo[i+2]. you don't nee it
 * after that. therefore, we can get rid of the memo table and just store a few variables.
 */

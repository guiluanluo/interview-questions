...
/**
 * Top-Down Dynamic Programming(or Memoization):  recursive + cache
 *
 * with just a small modification, we can tweak fib(i) function to rune O(N) time. we simple cache the results.
 */

...
public class Tower {
  ...
  public void moveDisks2(int n, Tower destination, Tower buffer) {
    ...
    moveDisks2(n - 1, buffer, destination);

    //move top from original to destination
    moveTopTo(destination);

    //move top n-1 disks from buffer to destination, using original as a buffer
    buffer.moveDisks2(n - 1, destination, this);

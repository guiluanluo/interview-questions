...
/*
 * If we observe how the recursion operations at Solution A, we'll notice that we have duplicated work.
 ...
 *          ....
 *
 * the second call to minProduct(4, 23) is unaware of the prior call, and so it repeats the same work.
 * we should cache there results.
 */

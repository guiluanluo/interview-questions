...
/**
 * Solution B: Bidirectional breadth-first-search. this means doing two breadth-first search, one from the source and
 * one from the destination. when the searches collide, we now we've found a path.
 */

 ...
 *
 * we will also design our array to be circular, such that the final stack may start at the end of the array and wrap
 * around to the beginning. please not that the code for this solution is far more complex than would be appropriate for
 * an interview. you could be responsible for pseudocode, or perphaps tht code of individual components, but the entire
...
public class MultiStack {
   ...
   * variables, but that’s messy and does not gain us much. */

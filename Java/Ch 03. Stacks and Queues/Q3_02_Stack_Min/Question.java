...
/**
 * Stack min: how would you design a stack which, addition to push and pop, has a function min which returns the minimum
 ...
 * this by having each node record what the minimum beneath itself is. then, to find the min, you just look at what the
 * top element thinks it the min. there just one issue with this: if we have a large stack, we waste a lot of space by
 * keeping track of the min for every single element. can we do better?
 *
...
public class Question {
  ...
  public static void main(String[] args) {
    ...
    System.out.println('\n');
    System.out.println(
        "stack: " + stack + ", min is " + stack.min() + ", " + stack2.min() + " [s2:" + stack2.s2.toString() + "]\n");

    for (int i = 0; i < array.length; i++) {
      System.out.println("Popped " + stack.pop().value + ", " + stack2.pop());
      System.out.println("New min is " + stack.min() + ", " + stack2.min() + " [s2:" + stack2.s2.toString() + "]\n");
    }
  }
